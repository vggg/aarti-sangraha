...
```bash
git remote add origin https://github.com/vggg/aarti-sangraha.git
...
A minute later the page is live at `https://vggg.github.io/aarti-sangraha/`.
...
```bash
python3 build/make_qr.py "https://vggg.github.io/aarti-sangraha/"
...
`vggg.github.io`, then set the custom domain under Settings → Pages.
